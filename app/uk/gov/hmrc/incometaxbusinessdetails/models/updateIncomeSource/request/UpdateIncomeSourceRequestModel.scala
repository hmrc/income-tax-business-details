...
package uk.gov.hmrc.incometaxbusinessdetails.models.updateIncomeSource.request
...
case class UpdateIncomeSourceRequestError(status: Int, reason: String) extends UpdateIncomeSourceRequest
