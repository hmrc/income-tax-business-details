...
import uk.gov.hmrc.incometaxbusinessdetails.constants.CreateHipBusinessDetailsTestConstants.{badRequestFailureResponse, failureHttpResponse, internalServerErrorFailureResponse, successHttpResponse, successResponse, validCreateSelfEmploymentRequest}
...
class CreateBusinessDetailsHipConnectorSpec extends TestSupport with MockHttpV2 {
  ...
  import TestCreateBusinessDetailsHipConnector.*
