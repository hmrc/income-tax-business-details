...
import uk.gov.hmrc.incometaxbusinessdetails.models.hip.incomeSourceDetails.{LatencyDetails, PropertiesRentedModel, PropertyDetailsModel, QuarterTypeElection}
