...
import uk.gov.hmrc.incometaxbusinessdetails.models.hip.core.{AccountingPeriodModel, AddressModel, ContactDetailsModel}
import uk.gov.hmrc.incometaxbusinessdetails.models.hip.incomeSourceDetails.{BusinessDetailsModel, LatencyDetails, PropertyDetailsModel, QuarterTypeElection}
import play.api.libs.json.{JsValue, Json}
import uk.gov.hmrc.incometaxbusinessdetails.constants.BaseIntegrationTestConstants.testMtdRef
